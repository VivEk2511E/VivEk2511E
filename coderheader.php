      ...
      <div class="row t-container" style="text-align: center;">
        ...
        <div class="row">
            <div class="row space10"></div>
             <nav id="nav" role="navigation">               	
	            <ul class="clearfix">
	           	<li class="active"><a href="coderhome.php" title="">View Project</a></li>
                                <li><a href="cviewreqstatus.php">Request Status</a></li>
                                <li><a href="cviewallotprj.php">Allotted Projects</a></li>
                                <li><a href="updatetech.php">Update Technology</a></li>
